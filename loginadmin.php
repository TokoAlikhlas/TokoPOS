  ...
  <body>
	...
	<?php
		if(isset($_POST['proses'])){
			...
			// $sql = 'select member.*, loginadmin.user, loginadmin.pass
			// 		from member inner join loginadmin on member.id_member = loginadmin.id_member
            // 		where user = $user';
			...
			if($jum > 0){
				...
				echo '<script>alert("Login Sukses");window.location="index2.php"</script>';
			}else{
