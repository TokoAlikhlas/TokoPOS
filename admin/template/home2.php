                      	...
                      	<div class="col-md-3">
                      		<div class="panel panel-primary">
								...
								<div class="panel-footer">
									<h4 style="font-size:15px;"><a href='index2.php?page=barang'>Tabel Barang <i class='fa fa-arrow-right'></i></a></h4>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
                      <!-- STATUS PANELS -->
                      ...
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-info">
								...
								<div class="panel-footer">
									<h4 style="font-size:15px;"><a href='index2.php?page=laporan'>Tabel laporan <i class='fa fa-arrow-right'></i></a></h4>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
                      	<div class="col-md-3">
                      		<div class="panel panel-danger">
								...
								<div class="panel-footer">
									<h4 style="font-size:15px;"><a href='index2.php?page=kategori'>Tabel Kategori <i class='fa fa-arrow-right'></i></a></h4>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
